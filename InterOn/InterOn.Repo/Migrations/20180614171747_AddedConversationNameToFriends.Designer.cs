...
namespace InterOn.Repo.Migrations
{
    ...
    [Migration("20180614171747_AddedConversationNameToFriends")]
    partial class AddedConversationNameToFriends
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterOn.Data.DbModels.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InterOn.Data.DbModels.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InterOn.Data.DbModels.Friend", b =>
                {
                    b.HasOne("InterOn.Data.DbModels.User", "UserA")
                        .WithMany()
                        .HasForeignKey("UserAId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("InterOn.Data.DbModels.User", "UserB")
                        .WithMany()
            ...
            modelBuilder.Entity("InterOn.Data.DbModels.Message", b =>
                {
                    b.HasOne("InterOn.Data.DbModels.User", "ReceiverUser")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("InterOn.Data.DbModels.User", "SenderUser")
                        .WithMany()
